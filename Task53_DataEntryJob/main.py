...
GOOGLE_FORM = "https://forms.gle/tYuRgkhEpf8vxQ8T9"
X_PATH_ADDRESS = '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[1]/div/div/div[2]/div/div[1]/div/div[1]/input'
X_PATH_PRICE = '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[2]/div/div/div[2]/div/div[1]/div/div[1]/input'
X_PATH_LINK = '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div[1]/div/div[1]/input'
X_PATH_SUBMIT = '//*[@id="mG61Hd"]/div[2]/div/div[3]/div[1]/div[1]/div/span/span'
...
for n in range(len(all_links)):
    ...
    time.sleep(2)
    # Take answer elements
    address = driver.find_element(by=By.XPATH, value= X_PATH_ADDRESS)
    price = driver.find_element(by=By.XPATH, value=X_PATH_PRICE)
    link = driver.find_element(by=By.XPATH, value=X_PATH_LINK)
    submit_button = driver.find_element(by=By.XPATH, value=X_PATH_SUBMIT)
