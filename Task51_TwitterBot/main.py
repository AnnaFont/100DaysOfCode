...
PROMISED_DOWN = 150
PROMISED_UP = 10
TWITTER_EMAIL = "annaf111@gmail.com"
TWITTER_PASSWORD = "twittertestpass"
...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        time.sleep(3)
        # Search for the GO button and click it

        go_button = self.driver.find_element(By.XPATH, value='//*[@id="container"]/div[1]/div[3]/div/div/div/div[2]/div[3]/div/div[1]/a/span[4]')
        go_button.click()
        time.sleep(60)
        down_speed = self.driver.find_element(By.XPATH, value='//*[@id="container"]/div[1]/div[3]/div/div/div/div[2]/div[3]/div/div[3]/div/div[3]/div/div/div[2]/div[1]/div[1]/div/div[2]/span')
        up_speed = self.driver.find_element(By.XPATH, value='//*[@id="container"]/div[1]/div[3]/div/div/div/div[2]/div[3]/div/div[3]/div/div[3]/div/div/div[2]/div[1]/div[2]/div/div[2]/span')
        print(f"Download internet speed: {down_speed.text} Mbps\nUpload internet speed: {up_speed.text} Mbps")
